...
public class GenericHTTPSWAClient
{
    //////////////
    ...
    public GenericHTTPSWAClient(String hostURL, String dataFileName, String attachment) throws Exception
    {
        m_hostURL = hostURL;
        ...
        System.out.println("Starting GenericHTTPSWAClient:");
		System.out.println("    host url        = " + m_hostURL);
		System.out.println("    data file       = " + m_dataFileName);
		if (m_attachment != null)
		    System.out.println("    attachment file = " + m_attachment);
    ...
    public static void main(String args[]) {
        ...
        try
        {
            GenericHTTPSWAClient soapClient =
                new GenericHTTPSWAClient(hostURL, dataFileName, attachment);
    ...
    private static void printUsage() {
        ...
        use.append("usage: java GenericHTTPSWAClient (options) ...\n\n");
        use.append("options:\n");
